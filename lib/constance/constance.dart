...
class ConstanceData {
  ...
  static final fslider3 = BaseImageUrl + "fslider3.jpg";
  static final fslider4 = BaseImageUrl + "fslider4.jpg";
  static final hslider1 = BaseImageUrl + "hslider1.png";
  static final hslider2 = BaseImageUrl + "hslider2.png";
  static final hslider3 = BaseImageUrl + "hslider3.png";
  static final hslider4 = BaseImageUrl + "hslider4.png";
  static final hyderabad = BaseImageUrl + "hyderabad.png";
  static final nslider1 = BaseImageUrl + "nslider1.jpg";
  static final nslider2 = BaseImageUrl + "nslider2.png";
  static final nslider3 = BaseImageUrl + "nslider3.jpg";
  static final nslider4 = BaseImageUrl + "nslider4.png";
  static final panjab = BaseImageUrl + "panjab.png";
  static final rajsthanRoyal = BaseImageUrl + "rajsthanRoyal.png";
  static final slider1 = BaseImageUrl + "slider1.jpg";
  static final slider2 = BaseImageUrl + "slider2.jpg";
  static final slider3 = BaseImageUrl + "slider3.jpg";
  static final slider4 = BaseImageUrl + "slider4.jpg";
  static final cricketerPic = BaseImageUrl + "cricketerPic.png";
  static final cricketGround = BaseImageUrl + "cricketGround.png";
  static final coupons = BaseImageUrl + "coupons.png";
  static final group = BaseImageUrl + "group.png";
  static final baseballPlayer = BaseImageUrl + "baseballPlayer.jpg";
  static final basketballPlayer = BaseImageUrl + "basketballPlayer.jpg";
  static final handballPlayer = BaseImageUrl + "handballPlayer.jpg";
  static final hockyPlayer = BaseImageUrl + "hockyPlayer.jpg";
  static final volleyballPlyer = BaseImageUrl + "volleyballPlyer.jpg";
  static final kabadiplayer = BaseImageUrl + "kabadiplayer.jpg";
  static final cricketPlayer = BaseImageUrl + "cricketPlayer.jpg";
  static final footballPlayer = BaseImageUrl + "footballPlayer.jpg";
  static final nflPlayer = BaseImageUrl + "nflPlayer.jpg";

  static final archer = BaseImageUrl + "archer.png";
  static final buttler = BaseImageUrl + "buttler.png";
  static final chahal = BaseImageUrl + "chahal.png";
  ...
  List<String> colors = ['#EB1165', '#32a852', '#e6230e', '#760ee6', '#008080', '#4FBE9F'];
}

int colorsIndex = 0;
String locale = "en";
AllTextData allTextData = new AllTextData();

var primaryColorString = '#008080';
