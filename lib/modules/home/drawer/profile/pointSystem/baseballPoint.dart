...
class _BaseballPointPageState extends State<BaseballPointPage> {
            ...
            child: ExpansionTile(
              ...
              children: [
                ...
                row(
                  ...
                  "12",
                  AppLocalizations.of('Batter hits it out of the park or reaches\nback to home base'),
                  (Colors.green[300])!,
                  Colors.white,
                ),
                SizedBox(
                ...
                row(
                  ...
                  "3",
                  AppLocalizations.of('Batter on strike caused one or more\nruns to be scored'),
                  (Colors.green[300])!,
                  Color(0xffFAFAFA),
                ),
                SizedBox(
                ...
                row(
                  ...
                  "3",
                  AppLocalizations.of('Player crosses home base to score a\nrun.'),
                  (Colors.red[300])!,
                  Color(0xffFAFAFA),
                ),
                SizedBox(
                ...
                row(
                  ...
                  "8",
                  AppLocalizations.of('Runner advances to next base while\npitcher is pitching'),
                  (Colors.red[300])!,
                  Color(0xffFAFAFA),
                ),
              ],
            ...
            child: ExpansionTile(
              ...
              children: [
                row(
                  ...
                  "3",
                  AppLocalizations.of('The pitcher gets 3 batters outs.The\npitcher gets 1 point per out.'),
                  (Colors.green[300])!,
                ...
                row(
                  ...
                  "2",
                  AppLocalizations.of('The pitcher throws three strikes to get\na batter out'),
                  (Colors.green[300])!,
                ...
                row(
                  ...
                  "-1",
                  AppLocalizations.of('When a batter reaches 1st ,2nd or 3rd\nbase'),
                  (Colors.green[300])!,
                  Theme.of(context).appBarTheme.color!.withOpacity(0.7),
                ),
                SizedBox(
                ...
                row(
                  ...
                  "3",
                  AppLocalizations.of("A walk occurs when a pitcher throws 4\n'balls' or illegal deliveries to the same\nbatter"),
                  (Colors.green[300])!,
                  Theme.of(context).appBarTheme.color!.withOpacity(0.2),
                ),
              ],
  ...
  Widget row(String txt1, String txt2, String txt3, Color color, Color containerColor) {
    return Row(
      children: [
        Expanded(
          child: Container(
